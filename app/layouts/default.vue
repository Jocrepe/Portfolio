...
<template>
    <div>
        ...
        <!-- Footer -->
        <footer class="border-t border-gray-700 mt-20 md:mt-32 lg:mt-40 flex flex-col items-center p-6 md:p-10">
            ...
            <div class="flex mt-3 text-center px-4">
                <p class="text-sm md:text-base">@2026 Krittapol Nammungkun All Rights Reserved</p>
            </div>
        </footer>
    </div>
</template>