        ...
        projects: [
            {
                ...
                other: [
                    'สามารถเข้าใช้งาน Admin Panel (Demo) ได้ที่ https://aire-nu.vercel.app/admin-login โดยใช้ข้อมูลเข้าสู่ระบบดังนี้:Email: admin01@mail.com , Password: admin1234  ***ในมือถือยังเข้าหน้า admin ไม่ได้นะครับ เพราะติดเรื่อง browser ในมือถือ มันบล็อค third party cookie',
